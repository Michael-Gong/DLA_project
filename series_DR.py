...
for n_snap in range(0, 50000, 500):
	print('This is '+str(n_snap).zfill(5)+' of '+str(100000))
        ...
        fig.savefig('./series_DR/series'+str(n_snap).zfill(6)+'.png',format='png',dpi=160)
        plt.close("all")
