...
#    ax.contour(X, Y, den_a.T, levels=[0.9], colors='limegreen', linewidths=2,origin='lower')
    ...
    plt.subplots_adjust(left=0.08, bottom=0.14, right=0.98, top=0.95, wspace=0.011, hspace=0.051)
...
#
    ...
    fig.savefig(to_path+'comb_fig1_2d_'+str(n).zfill(4)+'.png',format='png',dpi=160)
    plt.close("all")
    return 0
